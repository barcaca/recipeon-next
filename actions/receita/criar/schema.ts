...
const formSchema = z.object({
  ...
  imagem: z
    ...
    .refine(file => file.size <= MAX_FILE_SIZE, 'O tamanho máximo do arquivo é 5 MB.')
    .refine(
  ...
  descricao: z
    ...
    .min(10, 'A descrição da receita deve ter pelo menos 10 caracteres.'),
  categorias: z.string().array().nonempty('Escolha pelo menos uma categoria.'),
  ingredientes: z.array(ingredientesSchema),
  passos: z
    .string()
    .min(10, 'O passo deve ter pelo menos 10 caractere.')
    .array()
